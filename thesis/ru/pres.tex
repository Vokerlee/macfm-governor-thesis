...
\begin{frame}{Введение}
    \begin{enumerate}
      ...
      \item Производительность и энергопотребление ЦП в зависимости от политики регулирования частот
          для приложений реального времени.
      \item Эмуляция поведения компьютерных архитектур с помощью Gem5 как средство создания моделей производительности ЦП.

    \end{enumerate}
\end{frame}

\begin{frame}{Введение: пример организации памяти}
    \begin{figure}
        \centering
        \includegraphics[width=6.5cm]{MulticoreCacheRU.png}
...
\begin{frame}{Цели работы}
    \begin{enumerate}
      \item Разработать механизмы, позволяющие организовать сбор статистики микроархитектурных
          событий ядер ЦП (центрального процессора) при различных тактовых частотах.
...
\begin{frame}{Задачи}
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item Реализовать набор приложений, подходящих для построенной модели, и собрать для них
...
\begin{frame}{Обзор существующих решений}
    \begin{enumerate}
      \item Что-нибудь про то, что в линукс (взять из тезиса).
    \end{enumerate}
\end{frame}
...
\begin{frame}{Исследование и построение решения}
    \begin{enumerate}
      \item Сюда cpi формулу с параллелизмом памяти.
      \item Куча пунктов почему она мега-хороша (обощённость).
    \end{enumerate}
\end{frame}
...
\begin{frame}{Практическая часть}
    \begin{enumerate}
      \item Что-нибудь про драйверы clk, cpufreq
      \item Про бенчмарки, 3D график с данными => вывод про динамику.
      \item Что-нибудь про места вставок permut tracking, scheduler tick, migrations, context switches.
    \end{enumerate}
\end{frame}
...
\begin{frame}{Результаты}
    \begin{enumerate}
      \item Что-нибудь про выиграш в перфе.
    \end{enumerate}
\end{frame}
